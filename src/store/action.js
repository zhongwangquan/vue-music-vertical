...
import {setHistory,delHistoryOne,delHistoryAll,setPlayHistory,setFavoriteList,deleteFavoriteSong} from 'common/js/cache'
/**
...
export const setFavoriteListAction=({commit},song)=>{
  commit(types.SET_FAVORITE_LIST,setFavoriteList(Object.assign({},song)));
}
export const deleteFavoriteSongAction=({commit},song)=>{
  commit(types.SET_FAVORITE_LIST,deleteFavoriteSong(Object.assign({},song)));
}
